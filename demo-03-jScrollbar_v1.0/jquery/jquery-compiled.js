...
(function (A, w) {
  function ma() {
    ...
    var i = a.length;if (typeof b === "object") {
      ...
      f = !j && f && c.isFunction(d);for (o = 0; o < i; o++) e(a[o], b, f ? d.call(a[o], o, e(a[o], b)) : d, j);return a;
    }return i ? e(a[0], b) : w;
  }function J() {
    ...
    var b,
      ...
      }j = c(a.target).closest(f, a.currentTarget);n = 0;for (r = j.length; n < r; n++) for (k = 0; k < u.length; k++) {
    ...
    var d = 0;b.each(function () {
      if (this.nodeName === (a[d] && a[d].nodeName)) {
        var f = c.data(a[d++]),
          ...
          delete e.handle;e.events = {};for (var j in f) for (var i in f[j]) c.event.add(this, j, f[j][i], f[j][i].data);
        }
      }
    });
  }function sa(a, b, d) {
    ...
    return new c.fn.init(a, b);
      ...
      ya = Array.prototype.indexOf;c.fn = c.prototype = { init: function (a, b) {
    ...
    var a = arguments[0] || {},
    ...
    }if (typeof a !== "object" && !c.isFunction(a)) a = {};if (d === b) {
      a = this;--b;
      ...
      if (!c.isReady) {
        if (!s.body) return setTimeout(c.ready, 13);c.isReady = true;if (Q) {
          for (var a, b = 0; a = Q[b++];) a.call(s, c);Q = null;
      ...
      if (b.indexOf) return b.indexOf(a);for (var d = 0, f = b.length; d < f; d++) if (b[d] === a) return d;return -1;
    }, merge: function (a, b) {
      var d = a.length,
          f = 0;if (typeof b.length === "number") for (var e = b.length; f < e; f++) a[d++] = b[f];else for (; b[f] !== w;) a[d++] = b[f++];a.length = d;return a;
    }, grep: function (a, b, d) {
      for (var f = [], e = 0, j = a.length; e < j; e++) !d !== !b(a[e], e) && f.push(a[e]);return f;
    }, map: function (a, b, d) {
    ...
    return ya.call(b, a);
  };T = c(s);if (s.addEventListener) L = function () {
    ...
    var e = d.getElementsByTagName("*"),
      ...
      if (!(a.nodeName && c.noData[a.nodeName.toLowerCase()])) {
        a = a == A ? za : a;var f = a[G],
            e = c.cache;if (!f && typeof b === "string" && d === w) return null;f || (f = ++Ya);if (typeof b === "object") {
      ...
      cb = /^(a|area)$/i,
      Ba = /radio|checkbox/;c.fn.extend({ attr: function (a, b) {
      ...
      if (c.isFunction(a)) return this.each(function (n) {
        ...
        var e = this[d];if (e.nodeType === 1) if (e.className) {
          for (var j = " " + e.className + " ", i = e.className, o = 0, k = b.length; o < k; o++) if (j.indexOf(" " + b[o] + " ") < 0) i += " " + b[o];e.className = c.trim(i);
        } else e.className = a;
      }return this;
      ...
      if (c.isFunction(a)) return this.each(function (k) {
        ...
        var e = this[d];if (e.nodeType === 1 && e.className) if (a) {
          for (var j = (" " + e.className + " ").replace(Aa, " "), i = 0, o = b.length; i < o; i++) j = j.replace(" " + b[i] + " ", " ");e.className = c.trim(j);
        } else e.className = "";
      }return this;
      ...
      a = " " + a + " ";for (var b = 0, d = this.length; b < d; b++) if ((" " + this[b].className + " ").replace(Aa, " ").indexOf(a) > -1) return true;return false;
    }, val: function (a) {
      if (a === w) {
        var b = this[0];if (b) {
      ...
      if (!(a.nodeType === 3 || a.nodeType === 8)) {
        if (a.setInterval && a !== A && !a.frameElement) a = A;var e, j;if (d.handler) {
          ...
          var i = j.events = j.events || {},
              o = j.handle;if (!o) j.handle = o = function () {
            ...
            j = e ? c.extend({}, e) : { handler: d, data: f };if (k.indexOf(".") > -1) {
              ...
              u = i[k] = [];if (!z.setup || z.setup.call(a, f, r, o) === false) if (a.addEventListener) a.addEventListener(k, o, false);else a.attachEvent && a.attachEvent("on" + k, o);
            }if (z.add) {
      ...
      if (!(a.nodeType === 3 || a.nodeType === 8)) {
        var e,
          ...
          if (b && b.type) {
            ...
            b = b || "";for (e in C) c.event.remove(a, e + b);
          } else {
            for (b = b.split(" "); e = b[j++];) {
    ...
    isImmediatePropagationStopped: Y };var Da = function (a) {
  ...
  if (!c.support.changeBubbles) {
    var da = /textarea|input|select/i,
      ...
      var d = a.target,
        ...
        if (this.type === "file") return false;for (var a in ea) c.event.add(this, a + ".specialChange", ea[a]);return da.test(this.nodeName);
      }, teardown: function () {
    ...
    c.fn[b] = function (d, f, e) {
      if (typeof d === "object") {
        ...
        j = 0;for (var o = this.length; j < o; j++) c.event.add(this[j], d, i, f);
      }return this;
    };
  });c.fn.extend({ unbind: function (a, b) {
      if (typeof a === "object" && !a.preventDefault) for (var d in a) this.unbind(d, a[d]);else {
        d = 0;for (var f = this.length; d < f; d++) c.event.remove(this[d], a, b);
      }return this;
    ...
    function a(g) {
      ...
      l = l || [];var q = h = h || s;if (h.nodeType !== 1 && h.nodeType !== 9) return [];if (!g || typeof g !== "string") return l;for (var p = [], v, t, y, S, H = true, M = x(h), I = g; (f.exec(""), v = f.exec(I)) !== null;) {
        ...
        if (p.length === 2 && n.relative[p[0]]) t = ga(p[0] + p[1], h);else for (t = n.relative[p[0]] ? [h] : k(p.shift(), h); p.length;) {
        ...
        if (!m && p.length > 1 && h.nodeType === 9 && !M && n.match.ID.test(p[0]) && !n.match.ID.test(p[p.length - 1])) {
          ...
          v = m ? { expr: p.pop(), set: z(m) } : k.find(p.pop(), p.length === 1 && (p[0] === "~" || p[0] === "+") && h.parentNode ? h.parentNode : h, M);t = v.expr ? k.filter(v.expr, v.set) : v.set;if (p.length > 0) y = z(t);else H = false;for (; p.length;) {
      ...
      relative: { "+": function (g, h) {
          var l = typeof h === "string",
              m = l && !/\W/.test(h);l = l && !m;if (m) h = h.toLowerCase();m = 0;for (var q = g.length, p; m < q; m++) if (p = g[m]) {
          ...
          var l = typeof h === "string";if (l && !/\W/.test(h)) {
            ...
            m = 0;for (q = g.length; m < q; m++) if (p = g[m]) g[m] = l ? p.parentNode : p.parentNode === h;l && k.filter(h, g, true);
          }
        }, "": function (g, h, l) {
          var m = e++,
          ...
          g = " " + g[1].replace(/\\/g, "") + " ";if (p) return g;p = 0;for (var v; (v = h[p]) != null; p++) if (v) if (q ^ (v.className && (" " + v.className + " ").replace(/[\t\n]/g, " ").indexOf(g) >= 0)) l || m.push(v);else if (l) h[p] = false;return false;
        }, ID: function (g) {
      ...
      setFilters: { first: function (g, h) {
          ...
          var q = h[1],
            ...
            h = h[3];l = 0;for (m = h.length; l < m; l++) if (h[l] === g) return false;return true;
          } else k.error("Syntax error, unrecognized expression: " + q);
        }, CHILD: function (g, h) {
          var l = h[1],
              m = g;switch (l) {case "only":case "first":
              for (; m = m.previousSibling;) if (m.nodeType === 1) return false;if (l === "first") return true;m = g;case "last":
              for (; m = m.nextSibling;) if (m.nodeType === 1) return false;return true;case "nth":
              l = h[2];var q = h[3];if (l === 1 && q === 0) return true;h = h[0];var p = g.parentNode;if (p && (p.sizcache !== h || !g.nodeIndex)) {
                var v = 0;for (m = p.firstChild; m; m = m.nextSibling) if (m.nodeType === 1) m.nodeIndex = ++v;p.sizcache = h;
      ...
      z = function (g, h) {
        h = h || [];if (j.call(g) === "[object Array]") Array.prototype.push.apply(h, g);else if (typeof g.length === "number") for (var l = 0, m = g.length; l < m; l++) h.push(g[l]);else for (l = 0; g[l]; l++) h.push(g[l]);return h;
      };
    }var B;if (s.documentElement.compareDocumentPosition) B = function (g, h) {
      ...
      var g = s.createElement("div");g.appendChild(s.createComment(""));if (g.getElementsByTagName("*").length > 0) n.find.TAG = function (h, l) {
        l = l.getElementsByTagName(h[1]);if (h[1] === "*") {
          h = [];for (var m = 0; l[m]; m++) l[m].nodeType === 1 && h.push(l[m]);l = h;
        }return l;
    ...
    (function () {
      ...
      }g = n.relative[g] ? g + "*" : g;q = 0;for (var p = h.length; q < p; q++) k(g, h[q], l);return k.filter(m, l);
    ...
    if (c.isFunction(b)) return c.grep(a, function (e, j) {
      ...
      for (var b = this.pushStack("", "find", a), d = 0, f = 0, e = this.length; f < e; f++) {
        d = b.length;
        c.find(a, this[f], b);if (f > 0) for (var j = d; j < b.length; j++) for (var i = 0; i < d; i++) if (b[i] === b[j]) {
          b.splice(j--, 1);break;
        }
      }return b;
    }, has: function (a) {
    ...
    c.fn[a] = function (d, f) {
      ...
      b = b || 1;for (var f = 0; a; a = a[d]) if (a.nodeType === 1 && ++f === b) break;return a;
    }, sibling: function (a, b) {
      for (var d = []; a; a = a.nextSibling) a.nodeType === 1 && a !== b && d.push(a);return d;
    ...
    prepend: function () {
      ...
      function f(u) {
        ...
        e = i && i.parentNode;e = c.support.parentNode && e && e.nodeType === 11 && e.childNodes.length === this.length ? { fragment: e } : sa(a, this, o);k = e.fragment;if (j = k.childNodes.length === 1 ? k = k.firstChild : k.firstChild) {
          b = b && c.nodeName(j, "tr");for (var n = 0, r = this.length; n < r; n++) d.call(b ? f(this[n], j) : this[n], n > 0 || e.cacheable || this.length > 1 ? k.cloneNode(true) : k);
    ...
    c.fn[a] = function (d) {
        ...
        if (typeof i === "number") i += "";if (i) {
          if (typeof i === "string" && !jb.test(i)) i = b.createTextNode(i);else if (typeof i === "string") {
            i = i.replace(Ka, Ma);var o = (La.exec(i) || ["", ""])[1].toLowerCase(),
                k = F[o] || F._default,
                n = k[0],
                r = b.createElement("div");for (r.innerHTML = k[1] + i + k[2]; n--;) r = r.lastChild;if (!c.support.tbody) {
              n = ib.test(i);o = o === "table" && !n ? r.firstChild && r.firstChild.childNodes : k[1] === "<table>" && !n ? r.childNodes : [];for (k = o.length - 1; k >= 0; --k) c.nodeName(o[k], "tbody") && !o[k].childNodes.length && o[k].parentNode.removeChild(o[k]);
      ...
      for (var b, d, f = c.cache, e = c.event.special, j = c.support.deleteExpando, i = 0, o; (o = a[i]) != null; i++) if (d = o[c.expando]) {
        b = f[d];if (b.events) for (var k in b.events) e[k] ? c.event.remove(o, k) : Ca(o, k, b.handle);if (j) delete o[c.expando];else o.removeAttribute && o.removeAttribute(c.expando);delete f[d];
      }
    ...
    c.expr.filters.hidden = function (a) {
      ...
      xb = /^(\w+:)?\/\/([^\/?#]+)/,
      yb = /%20/g,
      zb = c.fn.load;c.fn.extend({ load: function (a, b, d) {
    ...
    c.fn[b] = function (d) {
      ...
      Bb = /^([+-]=)?([\d+-.]+)(.*)$/,
      W,
      va = [["height", "marginTop", "marginBottom", "paddingTop", "paddingBottom"], ["width", "marginLeft", "marginRight", "paddingLeft", "paddingRight"], ["opacity"]];c.fn.extend({ show: function (a, b) {
